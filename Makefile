...
build-macos: gen ## Build macOS app (set MACOS_DEVELOPMENT_TEAM or use Signing.local.xcconfig)
	@if [ -n "$(MACOS_DEVELOPMENT_TEAM)" ]; then \
		printf '// generated by make\nDEVELOPMENT_TEAM = %s\n' "$(MACOS_DEVELOPMENT_TEAM)" > macos/Runner/Configs/Signing.local.xcconfig; \
	fi
	flutter build macos
